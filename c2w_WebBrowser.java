...
public class c2w_WebBrowser extends Application {
    ...
    public void start(Stage stage){
        ...
        c2w_newBrowserWindow(c2w_url:"https://www.core2web.in/privacypolicy.html");
    ...
    void c2w_BrowserWindow(int c2w_url){
        ...
        System.out.println("The number of open windows is " + c2w_openWindows.size());
            if(c2w_openWindows.size() == 0){
                System.out.println("Program will end then because all windows are closed");
            }
    ...
    if(c2w_locationY + c2w_windowHeight +10 > c2w_screenRect.getMaxY()){
        ...
        c2w_locationY = c2w_screenRect.getMinY()+30;
